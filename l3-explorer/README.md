...
* `CORS_ORIGIN` - should be set to the origin of the `blockscout-frontend`
...
* `blockscout-frontend`: `golemnetwork/blockscout-frontend:main`
* `golem-base-indexer`: `golemnetwork/blockscout-golem-base-indexer:main`
